...
void VISSRDeframer::pushBit(uint8_t bit)
{
...
std::vector<std::vector<uint8_t>> VISSRDeframer::work(uint8_t *data, int len)
{
    // Output buffer
...
//template class SimpleDeframer<uint64_t, 64, 354848, 0b0100011010001101100101110010110101110010111011110010111001100010>;